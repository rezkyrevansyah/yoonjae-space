...
Stored in `.env.local` (never commit). Required keys:
...
⚠️  Do not paste real key values into this file or any tracked file. If a key has ever been committed, rotate it in the Supabase dashboard.
